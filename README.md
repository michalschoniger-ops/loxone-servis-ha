...
Verze 3.0.72 přináší Windows Launcher 3.0.0.16, který se aktualizuje až po ukončení původního procesu, opravuje zděděné atributy jen pro čtení a stahuje aktuální Stable, Beta a Alpha LOXONE Config přímo přes HTTPS do složky Stažené soubory bez Edge. Evora Smart Menu 3.0.48 vkládá Partner Coache s fotografií a kontakty přímo do panelu LOXONE Portálu, načte všech 18 řádků školení a faktury zobrazí pouze tehdy, když je partnerský účet opravdu zpřístupní. Zachovává ruční Miniservery, Windows Menu 3.0.34, technické macOS Menu 3.0.35 a databázové schéma 27.
