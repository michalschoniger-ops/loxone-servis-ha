...
Verze 2.0.7 opravuje profilové fotografie a jméno migrovaného hlavního účtu, zpřesňuje vzájemně výlučné počty dostupnosti a zachovává lokální cache ticketů i při chybě aktualizace Portálu. Sjednocuje mobilní menu a přidává jednorázové bezpečné zopakování cíle Loxone App při studeném startu na iPhonu. WorkLogAI integrace je součástí stejného vydání.
