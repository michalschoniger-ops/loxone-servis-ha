...
Verze 3.0.67 přidává bezpečný sanitovaný důvod nedostupnosti jednotlivých volitelných částí LOXONE Portálu bez obsahu odpovědi, cookie nebo tokenu. Navazuje na přehled certifikace, kreditu, obratu, objednávek, salda, pohledávek, školení, přímou rezervaci zasedaček do M365 a stavově řízené ikony docházky v Menu 3.0.44. Windows Menu zůstává 3.0.34 a technické macOS Menu 3.0.35; databázové schéma zůstává 26.
