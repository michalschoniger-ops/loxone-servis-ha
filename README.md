...
Verze 3.0.43 zachovává serverové změny 3.0.42: správcovské ruční doplnění telefonů kontaktů Intranetu, synchronní autentizovaný proklik Miniserveru, neblokující HLS kanálu 7 a dva šifrované serverové povely brány bez předávání adres klientům. Součástí je Evora Smart Menu 3.0.28 jako tmavé nativní macOS `NSMenu`: stavové snímky drží v paměti, při otevřené nabídce neprovádí těžké obnovy, Milesight ani Loxone Builder v nabídce nezobrazuje a kameru označí jako živou až po skutečném postupu videa. Kniha jízd může uložit validované počáteční a koncové GPS konkrétní jízdy; nejde o průběžné sledování zařízení. Databázi, šifrované přístupy ani vlastní názvy vydání nemaže.
