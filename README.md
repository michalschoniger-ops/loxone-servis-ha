...
Verze 2.0.4 dokončuje osobní Windows/Parallels Config Launcher, automatické obnovení přihlášení k Loxone Partner Portalu a správcovské centrum ticketů přímo v Hubu i WorkLogAI. Tickety a jejich veřejná komunikace se ukládají do šifrované lokální cache, přílohy se zobrazí nebo stáhnou podle dat dostupných z Portálu a mobilní rozvržení je ověřené také na iPhonu.
