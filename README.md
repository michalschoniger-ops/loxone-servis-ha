...
Verze 2.1.0 přidává jednotné stavy dat, centrum incidentů se SLA, servisní profily a kontakty, interní úkolové centrum, devítikrokový tester připojení a diagnostiku Windows Launcheru 2.1.0.0. Databázové schéma 18 uchovává nové provozní údaje, historii a šifrované přílohy přímo na hlavním Hubu.
