...
Verze 3.0.69 přidává v Evora Smart Menu 3.0.47 ruční založení Miniserveru buď v Hubu, nebo pouze v macOS Klíčence. Po připojení určí skutečný model z oficiálního `msInfo.miniserverType`, automaticky přiřadí fotografii a lokální záznam lze později synchronizovat do Hubu. Instalátor nově zachová oprávnění Klíčenky i mezi po sobě jdoucími ad-hoc podepsanými verzemi. Zachovává také vycentrovanou kartu Partner Coache s fotografií a kontakty, aktuální Stable, Beta a Alpha verzi Configu přes Windows Launcher 3.0.0.13, Windows Menu 3.0.34, technické macOS Menu 3.0.35 a databázové schéma 27.
