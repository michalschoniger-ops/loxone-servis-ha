...
Verze 1.0.0 přidává Home Assistant Fleet s řízenými aktualizacemi a restartem, bezpečný Config Bridge, barevné složky, rozcestník LOXONE podpory, produktové náhledy a profilové fotografie uživatelů.
