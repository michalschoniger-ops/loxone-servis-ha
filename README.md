...
Verze 3.0.0 sjednocuje Evora Smart Hub, Evora Smart Menu a Windows Config Launcher do jednoho vydání. Přidává opravenou docházku přes půlnoc, plynulý ticketový náhled, jednotné barevné menu, zelenou značku Intranetu a Windows pomocníka v oznamovací oblasti s automatickou aktualizací a diagnostikou. Oprava Launcheru 3.0.0.1 navíc bezpečně rozlišuje DNS/TLS/dostupnost Hubu, zachová staré párování až do prvního úspěšného heartbeat náhrady a umožní odebrat přístup počítače bez mazání jeho lokálních Windows souborů. Všechna data a šifrovaná připojení zůstávají zachovaná.
