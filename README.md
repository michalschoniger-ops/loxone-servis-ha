# EVORA Smart – Loxone Servis pro Home Assistant
...
Verze 0.4.1 přidává editovatelné složky projektů, ověřenou hierarchii Gateway/Client, přímé kopírování hesla a opravu lokálního Safari/HA Ingressu.
