...
Verze 2.0.9 sjednocuje mobilní menu bez rozmazání, doplňuje barevné složky, čitelná vlákna ticketů v Hubu i WorkLogAI a bezpečný katalog programových záloh Miniserveru. Při odstávce backendu se z dříve načteného aplikačního shellu zobrazí animovaný stav údržby.
