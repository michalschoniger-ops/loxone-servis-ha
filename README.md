...
Verze 2.0.6 dokončuje osobní Windows/Parallels Config Launcher, automatické obnovení přihlášení k Loxone Partner Portalu a správcovské centrum ticketů přímo v Hubu i WorkLogAI. Tickety a jejich veřejná komunikace se ukládají do šifrované lokální cache; skutečné přílohy lze otevřít a položky, u kterých Portál poskytl jen název, se zobrazují jako přehled bez falešného stažení. Mobilní rozvržení je ověřené také na iPhonu.
