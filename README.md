...
Verze 3.0.61 distribuuje Evora Smart Menu 3.0.43, bezpečné doplnění přístupů Miniserveru a auditovanou synchronizaci LOXONE Portálu se stavem registrace a Weather Service. Windows Menu zůstává 3.0.34 a technické macOS Menu 3.0.35; databázové schéma zůstává 26.
