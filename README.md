...
Verze 3.0.68 zpřesňuje historii školení podle aktuálního LOXONE Portálu, načítá Partner Coache včetně chráněné fotografie a kontaktů a vydává Menu aktuální Stable, Beta a Alpha verzi Configu. Evora Smart Menu 3.0.45 nedostupné volitelné části Portálu vůbec nezobrazuje a stažení Configu předává výhradně Windows Launcheru 3.0.0.13. Windows Menu zůstává 3.0.34 a technické macOS Menu 3.0.35; databázové schéma je 27.
