...
Verze 3.0.4 přidává úspornou chráněnou diagnostiku a ruční spuštění synchronizace aktivních servisních úkolů z listu `PROGRAMOVÁNÍ - DOKONČOVÁNÍ`. Hub dál importuje hodinově a bez duplikátů; sdílený Excel je pouze pro čtení, takže místní změny výslovně označí jako čekající zápis. Evora Smart Menu a Windows klient zůstávají ve verzi 3.0.1, Config Launcher ve verzi 3.0.0.2. Všechna data a šifrovaná připojení zůstávají zachovaná.
