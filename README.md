...
Verze 2.1.1 obsahuje jednotné stavy dat, centrum incidentů se SLA, servisní profily a kontakty, interní úkolové centrum, devítikrokový tester připojení a diagnostiku Windows Launcheru 2.1.0.0. Zároveň opravuje pád procesu při dočasné síťové chybě 1-Wire sběru; databázové schéma 18 i uložená data zůstávají zachovány.
