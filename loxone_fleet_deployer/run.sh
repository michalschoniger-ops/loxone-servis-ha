...
if [ "$OPERATION" = "rollback" ]; then
  ...
  case "$ORIGINAL_VERSION" in
    ...
    3.0.27|3.0.28|3.0.29|3.0.30|3.0.31|3.0.32|3.0.33|3.0.34|3.0.35|3.0.36) ;;
...
case "$CURRENT_VERSION" in
  ...
  3.0.33|3.0.34|3.0.35|3.0.36|3.0.37) ;;
