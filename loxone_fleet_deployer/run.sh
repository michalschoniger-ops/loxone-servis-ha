...
PAYLOAD_SHA256="84f5545146d8e136b3bb94c25b50ec20cd5be832f29371efd81a99cbcca41ec7"
...
if [ "$OPERATION" = "rollback" ]; then
  ...
  case "$ORIGINAL_VERSION" in
    0.4.8|0.4.9|0.4.10|0.4.11|0.4.12|0.4.13|0.4.14|0.4.15|0.5.0|0.5.1|0.5.2|1.0.0|1.0.1|1.0.2) ;;
