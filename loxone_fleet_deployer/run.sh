...
PAYLOAD_SHA256="aa204e7fceb2dd08ad5f5c2f0aa4d95446e3f429c8313227dfdc57660a29814b"
...
if [ "$OPERATION" = "rollback" ]; then
  ...
  case "$ORIGINAL_VERSION" in
    0.4.8|0.4.9|0.4.10|0.4.11|0.4.12|0.4.13|0.4.14|0.4.15|0.5.0|0.5.1|0.5.2|1.0.0|1.0.1) ;;
