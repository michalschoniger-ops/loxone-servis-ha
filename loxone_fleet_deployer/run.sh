...
PAYLOAD_SHA256="130f0fce9a20ccc88813a690b82edd33b7049b3bd6fa15db5b28ed0ba814b63e"
...
if [ "$OPERATION" = "rollback" ]; then
  ...
  case "$ORIGINAL_VERSION" in
    0.4.8|0.4.9|0.4.10|0.4.11|0.4.12|0.4.13|0.4.14|0.4.15|0.5.0|0.5.1|0.5.2|1.0.0|1.0.1|1.0.2|1.0.3|2.0.0|2.0.1|2.0.2|2.0.3|2.0.4|2.0.5|2.0.6|2.0.7|2.0.8|2.0.9|2.0.10|2.1.0|2.1.1|2.1.2|2.2.0|2.2.1|2.2.2|2.2.3|2.2.4|2.2.5|3.0.0|3.0.1|3.0.2|3.0.3) ;;
