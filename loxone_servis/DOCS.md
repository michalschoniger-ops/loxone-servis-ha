...
Hlavní navigace obsahuje pole **Hledat všude…**. Vyhledává bez ohledu na diakritiku v celé aplikaci: ve všech obrazovkách, podsekcích a dostupných datových záznamech; výsledek otevře přímo. Stejné globální hledání nabízí Evora Smart Menu 3.0.15 pro celé nativní macOS menu a všechny jeho vnořené položky; po přímém kliknutí pole udrží klávesový fokus. V samostatném hledání Miniserverů se shody zobrazí přímo pod sebou; složky zůstávají jen při běžném procházení.
