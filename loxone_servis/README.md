...
Vydání 3.0.74 přidává Evora Smart Menu 3.0.50 s vyhledávanými rychlými volbami po kliknutí pravým tlačítkem. Připnout lze konkrétní Miniserver pro Loxone Config, Loxone App nebo správu přístupů i vybrané funkce Menu. Historie docházky drží dvanáct měsíců a přidává měsíční souhrn; rezervace zasedaček je znovu dostupná přímo v nativním menu. Windows Launcher 3.0.0.16 dál stahuje Stable, Beta a Alpha Config přímo přes HTTPS do složky Stažené soubory ve Windows bez Edge.
